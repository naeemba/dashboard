...
const BLURBS: Record<Mode | ActionGroup, string> = {
  terminals: 'Five shells in a fixed grid. They keep running while you are on another project or '
    ...
    + 'bell to ask for you turns its project yellow along the top, and raises a system notification if '
    + 'the window is behind something else. Going to the pane clears it.',
