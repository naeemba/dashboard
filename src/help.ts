...
const BLURBS: Record<Mode | ActionGroup, string> = {
  terminals: 'Five shells in a grid. They keep running while you are on another project or '
    ...
    + 'restart. Leave the box empty to go back to following the title. A long name is cut to what the '
    + 'line has room for. The number stays in front of both, because the focus keys are numbered. '
