...
window.addEventListener('keydown', (event) => {
  // The picker, the help dialog, the delete confirmation and a card being edited own every key typed
  // inside them. xterm's textarea is outside all four, so a pane keeps its shortcuts.
