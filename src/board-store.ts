...
// undefined rather than an empty list, so a card that has never been commented on is written back
// without the field — a board from before comments existed round-trips as the file it was.
//
